...
//	delay_ms(10);
//	if(KEY0==0)LED1=!LED1;
//	EXTI_ClearITPendingBit(EXTI_Line4);//清楚Line4上的中断标志位
//}
////初始化PE4和PA0为中断输入
...
//	NVIC_InitStructure.NVIC_IRQChannelSubPriority=0x02;//相响应优先级2
//	NVIC_InitStructure.NVIC_IRQChannelCmd=ENABLE;//使能外部通道中断
